    ...
    <>
      ...
      <div className='cont'>
        ...
        <div className="sec">
          <img className='Achiimg' src={img13} alt="" />
          <div className="st1">
          Introduction to Metaverse course conducted and handled by PRAYA LABS- As an outcome of the course two students received internships at Praya Labs (Thiruvanamalai).
<br />
